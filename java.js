document.addEventListener("DOMContentLoaded", function() {
  ...
  const wordsArray = ["en student", "kreativ", "en søtnos", "en kjernekar", "en liten komiker", "6'7", "dødslig redd for fremtiden.", "arbeidsledig", "entusiaist for feminist literatur"];
  let currentIndex = 0;
